    ...
    <main>
      <section className="bg-gradient-to-br from-brand-700 via-brand-600 to-brand-800 text-white">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-24">
          <div>
            <p className="mb-4 inline-flex rounded-full bg-white/15 px-4 py-2 text-sm font-medium">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link to="/home" className="inline-flex items-center gap-2 rounded-xl bg-white px-5 py-3 font-semibold text-brand-700 hover:bg-brand-50">
                Browse resources
                <ArrowRight size={18} />
              </Link>
              <Link to="/signup" className="rounded-xl border border-white/30 px-5 py-3 font-semibold text-white hover:bg-white/10">
                Create account
              </Link>
            </div>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div key={item.label} className="rounded-2xl bg-white/10 p-6 backdrop-blur">
